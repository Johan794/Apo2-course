...
public class GUI {
   ...
   public void setPiechart(){
       ...
       mainGreed.add(pie,0,0);

   }

   @FXML
   public LineChart<Number,Number> setLinechart(){
   ...
   @FXML
   public AreaChart<Number,Number> setAreaChat(){
   ...
   @FXML
   public BubbleChart<Number,Number> setBubbleChart(){
   ...
   @FXML
   public ScatterChart<Number,Number> setScatterChart(){
